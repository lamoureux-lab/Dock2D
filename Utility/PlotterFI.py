...
if __name__ == "__main__":
    ...
    plt.margins(x=None)
    plt.legend(['Brute-force IF', 'Brute-force IF pretrained on brute-force IP', 'Brute-force IF pretrained on simplified IP', 'Sampled IF'])
    plt.ylabel('loss')
    plt.xlabel('epochs')
    xlim = 1000
    # plt.xlim([0, xlim])
